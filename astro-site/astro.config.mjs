        ...
        starlightSidebarTopics(
          [
            ...
            { label: 'Overview', slug: 'release-notes/release-notes-overview' },
            {
              ...
              collapsed: false,
              items: [
                { label: 'All 26.1 notes', link: '/release-notes/26-1-release-notes/' },
                { label: '26.1.3.1 (March 2026)', link: '/release-notes/26-1-release-notes/#26131-march-2026' },
                { label: '26.1.3 (March 2026)', link: '/release-notes/26-1-release-notes/#2613-march-2026' },
                { label: '26.1.2 (February 2026)', link: '/release-notes/26-1-release-notes/#2612-february-2026' },
                { label: '26.1.1 (January 2026)', link: '/release-notes/26-1-release-notes/#2611-january-2026' },
              ],
            },
            {
              label: '26.0',
              collapsed: true,
              items: [
                { label: 'All 26.0 notes', link: '/release-notes/26-0-release-notes/' },
                { label: '26.0.2.2 (December 2025)', link: '/release-notes/26-0-release-notes/#26022-december-2025' },
                { label: '26.0.2.1 (November 2025)', link: '/release-notes/26-0-release-notes/#26021-november-2025' },
                { label: '26.0.2 (November 2025)', link: '/release-notes/26-0-release-notes/#2602-november-2025' },
                { label: '26.0.1.2 (October 2025)', link: '/release-notes/26-0-release-notes/#26012-october-2025' },
                { label: '26.0.1.1 (October 2025)', link: '/release-notes/26-0-release-notes/#26011-october-2025' },
                { label: '26.0.1 (October 2025)', link: '/release-notes/26-0-release-notes/#2601-october-2025' },
              ],
            },
            {
              label: '4.13',
              collapsed: true,
              items: [
                { label: 'All 4.13 notes', link: '/release-notes/4-13-release-notes/' },
                { label: '4.13.4.2 (August 2025)', link: '/release-notes/4-13-release-notes/#41342-august-2025' },
                { label: '4.13.4.1 (August 2025)', link: '/release-notes/4-13-release-notes/#41341-august-2025' },
                { label: '4.13.4 (March 2025)', link: '/release-notes/4-13-release-notes/#4134-march-2025' },
                { label: '4.13.3 (January 2025)', link: '/release-notes/4-13-release-notes/#4133-january-2025' },
                { label: '4.13.2 (December 2024)', link: '/release-notes/4-13-release-notes/#4132-december-2024' },
                { label: '4.13.1 (November 2024)', link: '/release-notes/4-13-release-notes/#4131-november-2024' },
                { label: '4.13.0 (November 2024)', link: '/release-notes/4-13-release-notes/#4130-november-2024' },
              ],
            },

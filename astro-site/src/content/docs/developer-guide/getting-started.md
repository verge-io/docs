...
For detailed information on API key configuration, IP restrictions, and security best practices, see the [API Keys](../product-guide/system/api-keys) documentation.
...
|------|----------|----------|
| [Python SDK](sdks/python-sdk) | Python | Scripts, automation, data pipelines |
| [Go SDK](sdks/go-sdk) | Go | High-performance integrations, microservices |
| [PowerShell Module](sdks/powershell-module) | PowerShell | Windows automation, admin scripts |
...
|------|---------|----------|
| [vrg CLI](cli/vrg) | Terminal interface | Interactive management, quick operations |
| [Terraform Provider](iac/terraform-provider) | Infrastructure provisioning | Declarative infrastructure, GitOps workflows |
| [Ansible Collection](iac/ansible-collection) | Configuration management | Playbook-driven automation, fleet management |
| [Packer Plugin](iac/packer-plugin) | Image building | Automated VM template creation |

### For Monitoring & Observability

If you need to export VergeOS metrics to your monitoring stack:

- [Prometheus Exporter](monitoring/prometheus-exporter) — Export platform metrics to Prometheus and Grafana

## Next Steps

- **[API Reference](api-reference/overview)** — Explore the full REST API, including endpoints, filtering, and field selection
- **[Code Examples](code-examples)** — Common automation recipes and patterns
- **[Webhooks & Events](webhooks-events)** — Build event-driven integrations

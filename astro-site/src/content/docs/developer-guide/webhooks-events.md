...
VergeOS provides built-in webhook support that you can configure directly from the UI. For step-by-step instructions on setting up webhook endpoints and subscriptions, see the [Webhooks](../product-guide/automation/webhooks) page in the Product Guide.

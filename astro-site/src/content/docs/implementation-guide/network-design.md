...
Please review the [core concepts](/implementation-guide/concepts) first to learn more about VergeOS Network types before reviewing this document.
...
:::note[For environments with more than 2 nodes, switches are required for Core Fabric Networks]
:::
...
:::caution[Core Fabric Network - No Switch Hops Between Nodes]

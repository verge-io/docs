...
slug: knowledge-base/vm-configuration
...
**Previous**: VM powered on → [VM Power Management](api-vm-power-management)
**Common Next Steps**:
- Advanced operations → [VM Advanced Operations](api-vm-advanced-operations)
- Power cycle for changes → [VM Power Management](api-vm-power-management)
...
### Prerequisites
VM must be created first → See [VM Creation](api-vm-creation)
...
- **VM Creation**: See [VM Creation](api-vm-creation) for initial VM setup
- **Power Management**: See [VM Power Management](api-vm-power-management) for start/stop operations
- **Advanced Operations**: See [VM Advanced Operations](api-vm-advanced-operations) for cloning and snapshots
:::

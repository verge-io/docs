...
slug: knowledge-base/vm-creation-api
...
**Common Next Steps**:
- Power on VM → [VM Power Management](api-vm-power-management)
- Configure settings → [VM Configuration](api-vm-configuration)
...
### Next Steps
After VM creation → Power Management ([VM Power Management](api-vm-power-management))
...
- **Power Management**: See [VM Power Management](api-vm-power-management) for starting/stopping VMs
- **Configuration**: See [VM Configuration](api-vm-configuration) for CPU/RAM changes

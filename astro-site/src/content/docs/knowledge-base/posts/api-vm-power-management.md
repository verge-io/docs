...
slug: knowledge-base/vm-power-management
...
**Previous**: VM created → [VM Creation](api-vm-creation)
**Common Next Steps**:
- Configure VM settings → [VM Configuration](api-vm-configuration)
...
- **VM Creation**: See [VM Creation](api-vm-creation) for creating VMs

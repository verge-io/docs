...
slug: knowledge-base/customizing-the-user-interface
...
:::tip
Instructions for uploading files to the vSAN can be found [here](/product-guide/storage/uploading-files-to-vsan)
:::

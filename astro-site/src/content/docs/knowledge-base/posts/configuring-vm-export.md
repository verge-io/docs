...
slug: knowledge-base/configuring-a-vm-export-volume
...
2. Configure the volume:
    ...
    * **Quiesced**: Typically should be selected to provide application-consistent VM snapshots. **[VM Guest Agent](/product-guide/virtual-machines/vm-guest-agent) must be installed and registered to provide a quiesced VM snapshot.**

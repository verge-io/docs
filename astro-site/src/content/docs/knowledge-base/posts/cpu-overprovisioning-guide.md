...
slug: knowledge-base/cpu-overprovisioning-guide
...
```
Available Cores = (Nodes - 1) x Cores per Node
Usable vCPUs = Available Cores x Target Overcommit Ratio
```

**Example:** 4-node cluster, 32 cores each, 2:1 target ratio
- Available: (4-1) x 32 = 96 cores
- Usable vCPUs: 96 x 2 = 192 vCPUs

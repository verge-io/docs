...
slug: knowledge-base/importing-a-physicalvirtual-machine-into-vergeio
...
:::note
You can make a bootable USB using the [Creating Bootable Installation Media](/implementation-guide/install-media/) guide, substituting the Clone ISO.
:::

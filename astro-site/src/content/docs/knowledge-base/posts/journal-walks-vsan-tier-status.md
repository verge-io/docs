...
slug: knowledge-base/understanding-journal-walks-and-vsan-tier-status
...
:::tip
If missing data blocks have already been detected and a repair server isn't yet configured, it's not too late. [Setting up a repair server](/product-guide/backup-dr/repair-server) now allows VergeFS to automatically attempt recovery of those blocks during subsequent Journal Walks.
:::

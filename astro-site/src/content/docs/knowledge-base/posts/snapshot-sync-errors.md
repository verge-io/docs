...
slug: knowledge-base/snapshot-synchronization-errors-explained
date: 2023-01-24
---
...
:::note
For more information on Snapshots and Site Syncs, refer to our [Product Guide on Sync Configuration](/product-guide/backup-dr/sync-configuration).
:::

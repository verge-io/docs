...
slug: knowledge-base/tenant-node-planning-guide
...
:::tip
[This KB article](/knowledge-base/determine-node-where-vm-runs) provides information about using HA Groups for node anti-affinity
:::

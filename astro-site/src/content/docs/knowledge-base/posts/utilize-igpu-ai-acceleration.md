...
slug: knowledge-base/using-igpu-ai-acceleration
...
4. Select the iGPU device from the filtered list. *Be careful when selecting devices for resource groups. Choosing the wrong device can cause issues.*

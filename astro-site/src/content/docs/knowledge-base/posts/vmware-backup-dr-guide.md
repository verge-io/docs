...
slug: knowledge-base/vmwarebackupdrguide
date: 2023-01-24
---
...
:::note
The service VM NIC defaults to DHCP. To assign a static IP instead, see [Configuring VMware Service VM NIC IPv4 Settings](/knowledge-base/vmware-service-vm-nic-ipv4-configuration/).
:::

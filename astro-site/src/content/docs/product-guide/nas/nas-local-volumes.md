...
:::tip
A NAS service must be in place before creating volumes. See the [**NAS Service**](/product-guide/nas/nas-service) page for instructions.
:::
...
:::note[Encryption Considerations:]

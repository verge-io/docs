...
:::note
East/West port mirroring is typically only recommended for short durations. See: [**Port Mirroring**](/product-guide/networks/port-mirroring) for additional instructions.
:::

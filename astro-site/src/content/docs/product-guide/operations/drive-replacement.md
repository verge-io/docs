...
![Drive Count Box](/assets/product-guide/screenshots/drivecountbox.png)
...
![Drive listing warning](/assets/product-guide/screenshots/drivelisting-warning.png)

![Drive Dashboard](/assets/product-guide/screenshots/drivedashboard.png)
...
2. **Activate** the drive **LED**
    ...
    ![ledoff.png](/assets/product-guide/screenshots/ledoff.png)

    - If ***LED Status*** field indicates **Unsupported**, click **Locate LED** on the left menu.

   ![ledunsupported.png](/assets/product-guide/screenshots/ledunsupported.png)

3. The Diagnostics window will appear with settings pre-filled.  Click **Send ->** to activate the drive LED.

    ![diag-ledon.png](/assets/product-guide/screenshots/diag-ledon.png)
...
![diag-ledoff.png](/assets/product-guide/screenshots/diag-ledoff.png)

...
5. **Monitor Progress.** The node dashboard will provide information about the Maintenance Mode progress:
    ...
    - **Node Logs**
        ...
        ![Node log complete](/assets/product-guide/screenshots/nodelogcomplete.png)
    ...
    - **Running Machines**
        ...
        ![Running machines - one migrating](/assets/product-guide/screenshots/runningmachines-onemigrating.png)
    ...
    - **Node Status**
        ...
        ![Node status migrating](/assets/product-guide/screenshots/nodestatusmigrating.png)

        A status of ***"Maintenance Mode"*** indicates that all workloads have been successfully migrated/powered off.

        ![Node status maintenance mode](/assets/product-guide/screenshots/nodestatusmaintenancemode.png)
...
3. The ***Node Status*** displays "Leaving Maintenance" while in the process of coming out of Maintenance Mode.
    ...
    ![Node status leaving maintenance](/assets/product-guide/screenshots/nodestatusleavingmaint.png)
...
4. The ***Node Status*** field will display "Running" when it has fully come out of Maintenance Mode and workloads have been migrated back to the node.
    ...
    ![Node status running](/assets/product-guide/screenshots/nodestatusrunning.png)

...
4. Engage:
    * [OpenAI Router (common method)](open-ai-router): programmatically connect to the assistant via the built-in engine
    * [Interactive Chat Session](chat-sessions): communicate with the assistant within the VergeOS UI (helpful for testing)
...
:::note
GPU devices are distributed from pools called [Resource Groups](../system/device-pass-overview#resource-groups).
:::
...
<details><summary>Context Size Considerations</summary>

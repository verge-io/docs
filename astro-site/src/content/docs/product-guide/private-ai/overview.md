...
See [OpenAI-Compatible API](open-ai-router) for endpoint documentation.
...
For detailed setup instructions, see the [Configuration Guide](configuration).

## Related Documentation

- [Configuration](configuration) - Model and assistant setup
- [OpenAI-Compatible API](open-ai-router) - API endpoints and integration
- [Chat Sessions](chat-sessions) - Interactive UI usage

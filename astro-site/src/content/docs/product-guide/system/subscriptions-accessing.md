...
* Click the **Subscriptions icon (top right)** and select **All My Subscriptions** (to view all) or select **Page Subscriptions** (to view only subscriptions associated to the current page.)
  ...
  ![subscriptions-icon-white.png](/assets/product-guide/screenshots/subscriptions-icon-white.png)
  ...
  ![subscriptions-icon-orange.png](/assets/product-guide/screenshots/subscriptions-icon-orange.png)

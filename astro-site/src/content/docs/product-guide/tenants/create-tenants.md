...
:::tip
[KB Article: *Tenant Node Planning Guide*](/knowledge-base/tenant-node-planning-guide) walks through the considerations involved in deciding the number of tenant nodes to employ and RAM/Cores to assign to those tenant nodes.
:::
...
:::caution[Cloning Considerations]

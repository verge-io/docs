...
:::note[Tenant Storage and Deduplication]
...
![tenantssubscription-alert](/assets/product-guide/screenshots/tenantssubscription-alert.png)

### II. Example configuration - 7:15 am daily report of the All-Tenants Dashboard (overview information):

![tenantssubscription-report](/assets/product-guide/screenshots/tenantssubscription-report.png)

### III. Example configuration - weekly report (to the Administrators Group) showing summary information for a specific tenant:

![singletenantsubscription-report](/assets/product-guide/screenshots/singletenantsubscription-report.png)

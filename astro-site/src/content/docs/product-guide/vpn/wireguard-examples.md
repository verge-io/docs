...
![guard-b-peer.png](/assets/product-guide/screenshots/guard-b-peer.png)
![guard-b-peer2.png](/assets/product-guide/screenshots/guard-b-peer2.png)
...
6. Create a new Peer definition (for SystemB to connect here.)
   ...
   ![guard-a-peer.png](/assets/product-guide/screenshots/guard-a-peer.png)
   ![guard-a-peer2.png](/assets/product-guide/screenshots/guard-a-peer2.png)
...
**On SystemA:** navigate to the Network Dashboard (the network to which WireGuard is attached) ![guard-a-pingtest.png](/assets/product-guide/screenshots/guard-a-pingtest.png)
...
9. Click **Submit** to save the new peer entry.
    ![client-peer-form.png](/assets/product-guide/screenshots/client-peer-form.png)
...
![download-link.png](/assets/product-guide/screenshots/download-link.png)
![configuration-file.png](/assets/product-guide/screenshots/configuration-file.png)
...
(In this example, we download and install WireGuard for Windows-64bit to use on a Windows 10 Pro machine.)
    ![add-tunnel.png](/assets/product-guide/screenshots/add-tunnel.png)
...
3. The configuration file is used to automatically create an interface and peer on the client machine. Click the **Activate** button to open the tunnel, if it was not automatically activated.
   ![tunnel-active.png](/assets/product-guide/screenshots/tunnel-active.png)

...
Hands-on technical training for architecting, deploying, and operating VergeOS infrastructure.

<div class="training-actions">
  <LinkButton href="/training/01-architecture/" icon="right-arrow">Start Module 1</LinkButton>
  <LinkButton href="#modules" variant="minimal">View All Modules</LinkButton>
</div>

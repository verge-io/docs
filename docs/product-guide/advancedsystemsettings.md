...
| ***Override physical network for new tenants (172.17.0.0/24)*** | !!! warning "Changing default network addressing in typically not recommended.  Work closely with VergeOS Support to implement any network addressing changes." | |

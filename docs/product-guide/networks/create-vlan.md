...
!!! info "Tenant Configuration"
    For VLAN configuration within a tenant, [Virtual Wires](/product-guide/networks/virtual-wires) must first be configured to provide external layer2 access to the tenant.

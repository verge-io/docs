...
Internal networks are originated within VergeOS; an internal network can be created as [**Layer3**](/product-guide/networks/internal-layer3) (recommended)  or  [**Layer2**](/product-guide/networks/internal-layer2)
...
> East/West port mirroring is typically only recommended for short durations. See: [**Port Mirroring**](/product-guide/networks/port-mirroring) for additional instructions. {.is-info}  

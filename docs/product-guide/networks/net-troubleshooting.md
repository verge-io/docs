...
>  It is generally recommended to use DHCP on Internal networks, rather than simply assigning addresses within the VM guest OS.  Static DHCP can be configured to reserve particular addresses to particular VMs: [**Create a DHCP Static Entry**](/product-guide/networks/dhcp-static-lease) {.is-info}
...
3.  An unsuccessful ping may indicate an incorrect network configuration.
...
**Example:**
![defaultgw-create.png](/product-guide/screenshots/defaultgw-create.png) <br>
 <br>

...
![vdi-console.png](/docs/public/userguide-sshots/vdi-console.png)
...
#### ![exiticon.png](/docs/public/userguide-sshots/exiticon.png) Exit
Exits the console and returns to the previous screen.
<br>

####  ![expandconsole-icon.png](/docs/public/userguide-sshots/expandconsole-icon.png) Expand console
Activates/deactivates the console's full-screen option (expand to entire browser tab)
<br>

#### ![virtkeyboard-icon.png](/docs/public/userguide-sshots/virtkeyboard-icon.png) Virtual Keyboard
Provides a virtual keyboard on devices that do not have a physical keyboard (cellphones, tables, etc.)
<br>

#### ![dragview-icon.png](/docs/public/userguide-sshots/dragview-icon.png) Drag view port
Alows moving the viewable portion of the console when the guest system screen exceeds the viewable area. 
<br>

#### ![browserfullscreen-icon.png](/docs/public/userguide-sshots/browserfullscreen-icon.png) Toggle Browser Full Screen
Activates/deactivates the browser's full-screen option.
<br>

#### ![eject-icon.png](/docs/public/userguide-sshots/eject-icon.png) Change/Eject CD-ROM
Toggles the view of the CD-ROM selection form, where an \*.iso file is selected.
<br> 

#### ![clipboard-icon.png](/docs/public/userguide-sshots/clipboard-icon.png) Clipboard
...
#### ![power-icon.png](/docs/public/userguide-sshots/power-icon.png) Power
...
#### ![extrakeys-icon.png](/docs/public/userguide-sshots/extrakeys-icon.png) Extra Keys
...
#### ![chat-icon.png](/docs/public/userguide-sshots/chat-icon.png) Chat

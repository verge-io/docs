---
title: Product Guide - Connect VeregOS to an Existing LAN/WAN
description: Instructions for connecting to a network outside of your VeregOS environnment, such as company LAN, WAN connection, etc.
published: true

...
{% hint style="info" %}
**For more information on Snapshots and Site Syncs, refer to our [Product Guide on Sync Configuration](https://docs.verge.io/product-guide/backup-dr/sync-configuration/).**
{% endhint %}

...
The public address must be [Assigned from the External network](https://docs.verge.io/product-guide/networks/assign-external-ip/) to the VPN network.
...
**Translate Rule:**
![VPN Translate to Router](../.gitbook/assets/ipsec-dedicated-bridged-vpn-translate.png)

{% hint style="info" %}
**The translate rule must be moved to the top of the rules list, before the *Accept* Rules.  Instructions for changing the order of rules can be found in the Product Guide: [Network Rules - Change the Order of Rules](https://docs.verge.io/product-guide/networks/network-rules/#change-the-order-of-rules)**
{% endhint %}

**Default Route Rule:**
![VPN Default Route Rule](../.gitbook/assets/ipsec-dedicated-bridged-vpn-defroute.png)

...
{% hint style="info" %}
**For detailed instructions on drive replacement, refer to the Maintenance section in the inline help under **[Drive Replacement](https://docs.verge.io/product-guide/system/drive-replacement/)**. This section guides you through the entire process.**
{% endhint %}

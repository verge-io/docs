...
Please review the complete [vSAN Scale Up SOP](https://docs.verge.io/product-guide/operations/vsan-scale-up-sop/) for comprehensive preparation, execution, and verification procedures.
{% endhint %}
...
**Required Reading:** The [vSAN Scale Up Standard Operating Procedure](https://docs.verge.io/product-guide/operations/vsan-scale-up-sop/) contains essential preparation, verification, and troubleshooting steps that must be completed before and after this scale up process.
{% endhint %}

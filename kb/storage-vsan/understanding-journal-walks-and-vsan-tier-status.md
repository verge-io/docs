...
{% hint style="success" %}
**If missing data blocks have already been detected and a repair server isn’t yet configured, it’s not too late. [Setting up a repair server](https://docs.verge.io/product-guide/backup-dr/repair-server/) now allows VergeFS to automatically attempt recovery of those blocks during subsequent Journal Walks.**
{% endhint %}
...
* Follow recommended [Node Sizing Requirements](https://docs.verge.io/implementation-guide/sizing/) (e.g. dedicated tier 0 using NVME drives, right-sizing controller memory for your environment)
* Implement [Network Design](https://docs.verge.io/implementation-guide/network-design/) recommendations (e.g. adequate internode bandwidth of at least 10Gb, isolated, dedicated core networks)

...
For more details on cluster monitoring, see [Clusters Overview](https://docs.verge.io/product-guide/system/clusters-overview/).
...
- [Clusters Overview](https://docs.verge.io/product-guide/system/clusters-overview/) - Understanding cluster architecture
- [Cluster Configuration Options](https://docs.verge.io/product-guide/system/cluster-settings/) - All cluster settings explained
- [VM Best Practices](https://docs.verge.io/product-guide/virtual-machines/vm-best-practices/) - Recommendations for VM configuration
- [Creating Virtual Machines](https://docs.verge.io/product-guide/virtual-machines/creating-vms/) - VM creation guide
- [Live Migrations](https://docs.verge.io/product-guide/virtual-machines/live-migrations/) - Moving VMs between nodes

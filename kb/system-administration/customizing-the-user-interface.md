...
{% hint style="success" %}
**Instructions for uploading files to the vSAN can be found [here](https://docs.verge.io/product-guide/storage/uploading-files-to-vsan/)**
{% endhint %}

2. **Create one or more Custom Themes**: to implement your branding
Refer to the [Themes Product Guide](https://docs.verge.io/product-guide/system/themes/) for instructions.

...
By adding iGPUs from multiple nodes into the same resource group, you create a shared pool of acceleration resources that AI models can draw from. For more details, see [Resource Groups](https://docs.verge.io/product-guide/system/device-pass-overview/#resource-groups)
{% endhint %}
...
The model will now draw from any available iGPUs in the resource group. For more information on Private AI configuration, see [Private AI Configuration](https://docs.verge.io/product-guide/private-ai/configuration/).

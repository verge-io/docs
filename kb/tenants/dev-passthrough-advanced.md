...
{% hint style="danger" %}
**It is important to read and be familiar with [**PCI Passthrough Risks and Precautions**](https://docs.verge.io/product-guide/system/device-pass-overview/#pci-passthrough-risksprecautions) before making passthrough configurations.**
{% endhint %}

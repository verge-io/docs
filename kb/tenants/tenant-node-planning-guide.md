...
Before using this guide, you should have a general foundational understanding of tenant concepts; refer to the [Tenants Overview](https://docs.verge.io/product-guide/tenants/overview/) if you are new to VergeOS tenants.
...
For detailed procedures on increasing tenant resources, refer to the [Increase Tenant Resources](https://docs.verge.io/product-guide/tenants/add-tenant-resources/) documentation.

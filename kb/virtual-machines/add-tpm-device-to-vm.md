...
- [Virtual Machine Best Practices](https://docs.verge.io/product-guide/virtual-machines/vm-best-practices/)
- [UEFI Import Guide](importing-windows-server-with-uefi-into-vergeos.md)
- [Device Passthrough Overview](https://docs.verge.io/product-guide/system/device-pass-overview/)

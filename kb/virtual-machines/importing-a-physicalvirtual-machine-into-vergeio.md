...
{% hint style="info" %}
**You can make a bootable USB using the [Creating Bootable Installation Media](https://docs.verge.io/implementation-guide/install-media/) guide, substituting the Clone ISO.**
{% endhint %}

...
1. **Import the VM** from the VMware service. Follow the steps from [this guide](https://docs.verge.io/product-guide/virtual-machines/import-from-vmware/) to import the VM into VergeOS.

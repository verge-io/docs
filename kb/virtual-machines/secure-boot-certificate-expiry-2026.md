...
- [Licensing and Software Updates](https://docs.verge.io/product-guide/system/licensing-and-updates/)
...
If you encounter issues applying the Secure Boot certificate fix or have questions about affected VMs, please don't hesitate to reach out to the [VergeOS Support Team](https://docs.verge.io/support/).
{% endhint %}

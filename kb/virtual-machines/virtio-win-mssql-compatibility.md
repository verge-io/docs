...
- [VM Snapshots and Restores](https://docs.verge.io/product-guide/backup-dr/vm-snapshots-restores/)
...
If you are seeing read-retry messages or instability on a Windows MS SQL VM and are unsure which virtio-win version is installed — or which build to upgrade to — please reach out to the [VergeOS Support Team](https://docs.verge.io/support/) before making driver changes in production.
{% endhint %}
